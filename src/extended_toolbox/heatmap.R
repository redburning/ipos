  ...
  fluidPage(
    ...
    box(
      ...
      tags$div(
        ...
        tags$div(
          style = "width:calc(100% - 520px); max-width:calc(100% - 520px); height:auto;",
          hidden(div(id = ns("resultdiv-toolbox-heatmap"),
        ...
        tags$div(
          style = "width:270px; height:100%; background-color:white; z-index:1001;",
          tags$div(
            ...
            tags$div(
              ...
              buildAccordionItem(id = 'toolbox-heatmap-title-settings', title = 'Title', collapsed = TRUE),
              tags$div(id = 'toolbox-heatmap-title-settings', class = 'collapse-item-body', style = 'display:none;',
            ...
            tags$div(
              style = 'border-bottom: 1px solid rgba(36, 41, 46, 0.12);',
              buildAccordionItem(id = 'toolbox-heatmap-panel-settings', title = 'Panel', collapsed = TRUE),
              tags$div(id = 'toolbox-heatmap-panel-settings', class = 'collapse-item-body', style = 'display:none;',
            ...
            tags$div(
              style = 'border-bottom: 1px solid rgba(36, 41, 46, 0.12);',
              buildAccordionItem(id = 'toolbox-heatmap-annotation-settings', title = 'Annotation', collapsed = TRUE),
              tags$div(id = 'toolbox-heatmap-annotation-settings', class = 'collapse-item-body', style = 'display:none;',
            ...
            tags$div(
              style = 'border-bottom: 1px solid rgba(36, 41, 46, 0.12);',
              buildAccordionItem(id = 'toolbox-heatmap-size-settings', title = 'Size', collapsed = TRUE),
              tags$div(id = 'toolbox-heatmap-size-settings', class = 'collapse-item-body', style = 'display:none;',
            ...
            # Export
            tags$div(
              buildAccordionItem(id = 'toolbox-heatmap-export-settings', title = 'Export', collapsed = TRUE),
              tags$div(id = 'toolbox-heatmap-export-settings', class = 'collapse-item-body', style = 'display:none;',
                       # export plot
                       tags$div(
...
heatmapServer <- function(input, output, session) {
  ...
  observeEvent(input$dataloader$datapath, {
    tryCatch({
      dataset <<- read.csv(input$dataloader$datapath, stringsAsFactors = TRUE, check.names = FALSE, row.names = 1)
      output$data_summary_matrix <- renderUI({
        tags$div(
          ...
          tags$span(ncol(dataset), style = 'background-color: #55b599; color:white; padding:2px 5px; font-size:12px; border-radius: 0 4px 4px 0;'),
  ...
  observeEvent(input$attachmentloader_sample_group$datapath, {
    ...
    tryCatch({
      attachment <- read.csv(input$attachmentloader_sample_group$datapath, stringsAsFactors = TRUE, check.names = FALSE, row.names = 1)
  ...
  observeEvent(input$attachmentloader_var_class$datapath, {
    tryCatch({
      attachment <- read.csv(input$attachmentloader_var_class$datapath, stringsAsFactors = TRUE, check.names = FALSE, row.names = 1)
      if (nrow(attachment) > 0 && ncol(attachment) == 1) {
  ...
  observeEvent(input$execute, {
    tryCatch({
      if (is.null(dataset)) {
        ...
        shinyjs::show("resultdiv-toolbox-heatmap")
        # heatmap
