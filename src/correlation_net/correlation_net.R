  ...
  fluidPage(
    fluidRow(
      tags$div(
        ...
        fluidRow(
          column(width = 12,
                 box(title = "相关网络", collapsible = TRUE, collapsed = FALSE, width = 12,
                     solidHeader = TRUE,
                 )
                 )
        )
...
correlationNetServer <- function(input, output, session) {
